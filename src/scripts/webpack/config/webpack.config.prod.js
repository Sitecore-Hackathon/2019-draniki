...
const publicPath = '/dist/Draniki/Project/Draniki/';
// Source maps are resource heavy and can cause out of memory issue for large source files.
const argv = process.argv.slice(2);

const shouldUseSourceMap = argv.indexOf('--debug') !== -1;
...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      inject: false, // TODO: verify if `inject` property or custom logic should be used for inserting JS, CSS, etc.
